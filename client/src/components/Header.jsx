...
function Header() {
  ...
  return (
    <div className='fixed w-full mt-2 pl-2 pr-2 '>
    <header className=" bg-gradient-to-b from-cyan-500 via-cyan-700 to-cyan-900 flex items-center justify-between h-12 bg-slate-300  shadow-md py-6 px-6 rounded-lg">
