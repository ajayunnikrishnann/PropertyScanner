...
export default  function ListingsFeaturingAuction() {
  ...
  return (
    ...
    <button onClick={() => setContact(true)} className='bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 p-3'>Send mail to landlord</button>
  </>
)}
